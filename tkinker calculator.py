...
def evaluate_calculation():
    ...
    try:
        ...
        text_result.delete(1.0, "end")
        text_result.insert(1.0, calculation)
    except: # ignore erros like dividing by 0
        clear_field()
        text_result.insert(text_result, "Error")
...
#row 3
btn_4 = tk.Button(root, text="3", command=lambda: add_to_calculation(3), width=5, font=("Arial",14))
